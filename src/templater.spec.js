...
describe('Templater', () => {
    ...
    it('12121', () => {
        ...
        expect(template.toString()).toBe('<div class="awesome" id="header"><p>Hello</p><p>World</p><br id="125"><br></div>')
    })
    it('21', () => {
        const template = Templater().div(
            Templater().p('Hello'),
        ...
        expect(template.toString()).toBe('<div><p>Hello</p><p>World</p><div>div</div><br id="125"><br></div><p>p</p>')
    })
    it('3', () => {
