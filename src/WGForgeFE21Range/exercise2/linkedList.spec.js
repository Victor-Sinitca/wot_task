...
describe("func1", () => {
    it('1', () => {
        ...
        list.add(2)
        list.add(3)
        expect(addAllList(list)).toEqual(exp)
    ...
    it('9', () => {
        ...
        list.add(1)
        list.add(2)
        expect(addAllList(list)).toEqual([0, 1, 2])
        list.remove(0)
        expect(addAllList(list)).toEqual([1, 2])
        list.add(4,0)
        expect(addAllList(list)).toEqual([4,1,2])
        list.add(4,)
        expect(addAllList(list)).toEqual([4,1,2,4])
        list.remove(3)
        expect(addAllList(list)).toEqual([4,1,2])
        list.add(5,)
        expect(addAllList(list)).toEqual([4,1,2,5])
    ...
    it('10', () => {
        const list = new LinkedList()
        list.add(5,0)
        expect(addAllList(list)).toEqual([5])
        list.add(4,0)
        expect(addAllList(list)).toEqual([4,5])
        list.remove(1)
        expect(addAllList(list)).toEqual([4])
        list.remove(0)
        expect(addAllList(list)).toEqual([])
        list.add(5,)
        list.add(6,)
        list.add(7,)
        list.remove(0)
        expect(addAllList(list)).toEqual([6,7])
    ...
    it('11', () => {
        ...
        expect(()=> {list.add(5, addAllList)}).toThrow(errorMessage)
        expect(()=> {list.add(5, "u8")}).toThrow(errorMessage)
        list.add(1, "1")
        expect(addAllList(list)).toEqual([5,1])
    })
